    ...
    <script src="assets/dashforge/js/jquery.js"></script>
    <script src="assets/dashforge/js/bootstrap.bundle.min.js"></script>
    <script src="assets/dashforge/js/feather.min.js"></script>
    <script src="assets/dashforge/js/perfect-scrollbar.min.js"></script>

    <script src="assets/dashforge/js/dashforge.js"></script>
    <script src="assets/dashforge/js/dashforge.contacts.js"></script>

    <!-- append theme customizer -->
    <!--script src="assets/dashforge/js/js.cookie.js"></script>
    <script src="assets/dashforge/js/dashforge.settings.js"></script-->
    <script>
      $(function(){
        'use script'
