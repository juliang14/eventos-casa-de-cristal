...
class Inventarios extends DB{
	...
	public function getInventario($Id_inventario){
		try {
			//Preparar la comsulta que se va a realizar
	...
	public function createInventario( $Inventario, $Cantidad, $Valor_sin_iva, $Categoria){
		try {
			//Preparar la comsulta que se va a realizar
	...
	//Crear Inventario
	public function editInventario( $Id_inventario, $Inventario, $Cantidad, $Valor_sin_iva, $Categoria){
		try{
	...
	//Borrar empleado
	public function borrarInventario($Id_inventario){
		try {
